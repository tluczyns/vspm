package tl.loader {
	...
	public dynamic class SoundExt extends Sound {
		...
		public function tweenVolume(destVolume: Number, stepChangeVolume: Number = 0.1, onComplete: Function = null, onCompleteParams: Array = null, ease: * = null): uint {
			...
			Tweener.addTween(this, {initVolume: destVolume, time: numFramesChangeVolume, useFrames: true, transition: ease, onUpdate: this.setVolumeSelf, onUpdateScope: this, onComplete: onComplete, onCompleteScope: this, onCompleteParams: onCompleteParams});
